...
export default function AccessControlPanel({ deviceId }: Props) {
    ...
    const handleToggle = async (access: UserAccessResponse) => {
        if (access.permissionLevel === 'OWNER') return;
    ...
    return (
        <div className="space-y-4">
            {/* Grant new access */}
            <div className="p-3 rounded-lg bg-zinc-800/30 border border-zinc-800/60 space-y-3">
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-sm bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl shadow-black/40 p-6">
                        ...
                        <p className="text-sm text-zinc-400 mb-5">
                            Remove <span className="text-zinc-200 font-medium">{revokeTarget.username}</span>'s access to this device?
                        </p>
