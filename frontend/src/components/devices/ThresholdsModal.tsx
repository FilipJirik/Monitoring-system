...
export default function ThresholdsModal({ open, deviceId, deviceName, onClose }: Props) {
    ...
    return (
        <Modal open={open} onClose={onClose} title={`Thresholds — ${deviceName}`} maxWidth="max-w-2xl">
