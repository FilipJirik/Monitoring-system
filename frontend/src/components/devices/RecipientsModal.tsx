...
export default function RecipientsModal({ open, deviceId, deviceName, onClose }: Props) {
    ...
    useEffect(() => {
        if (open && deviceId) fetchRecipients();
    ...
    return (
        <Modal open={open} onClose={onClose} title={`Recipients — ${deviceName}`} maxWidth="max-w-2xl">
